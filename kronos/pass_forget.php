...
if (isset($_POST['mail'])) {
	if (!$validacion->existeUsuarioConEsteEmail($_POST['mail'])) {
		...
		$forget_pass = $usuario->resetearPass($_POST['mail']);
		$mensajes[] = "Revise su correo para conocer su nueva contraseña.";
	}
 }
								...
								<center>
									<div class="panel panel-smart">
			 							<div class="panel-heading">
			 								<h3 class="panel-title">Resetear mi contraseña</h3>
			 							</div>
										...
										<?php if (!isset($forget_pass)): ?>
											...
											<!-- Login Form Starts -->
											<form action="pass_forget.php" method="POST" class="form-inline" role="form">
...
<br><br>
									<p>> Ya la recuerdo, <a href="login.php">¡quiero loguearme!</a></p>
											</form>
